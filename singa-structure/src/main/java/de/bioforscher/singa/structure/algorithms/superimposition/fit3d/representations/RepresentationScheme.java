...
/**
 * This represents a representation scheme of a {@link GraphLeafSubstructure}. When applied to a {@link
 * GraphLeafSubstructure} the concrete implementation tries to reduce all {@link GraphAtom}s to a single artificial
 * atom.
 *
 * @author fk
 */
public interface RepresentationScheme {
     ...
     *
     * @param leafSubstructure The {@link GraphLeafSubstructure} for which the one atom representation should be
     * calculated.
