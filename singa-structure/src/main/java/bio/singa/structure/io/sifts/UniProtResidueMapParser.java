 ...
 * @author cl
 */
public class UniProtResidueMapParser extends AbstractXMLParser<Map<UniProtIdentifier, Map<AuthLeafIdentifier, Integer>>> {
    ...
    public static Map<UniProtIdentifier, Map<AuthLeafIdentifier, Integer>> parse(String pdbIdentifier) {
        return UniProtResidueMapParser.parse(new PDBIdentifier(pdbIdentifier));
    }

    public static Map<UniProtIdentifier, Map<AuthLeafIdentifier, Integer>> parse(PDBIdentifier pdbIdentifier) {
    ...
    @Override
    public Map<UniProtIdentifier, Map<AuthLeafIdentifier, Integer>> parse() {
        parseXML();
