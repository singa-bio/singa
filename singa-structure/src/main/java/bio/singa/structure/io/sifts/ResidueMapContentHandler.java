...
public class ResidueMapContentHandler implements ContentHandler {
    ...
    public Map<UniProtIdentifier, Map<AuthLeafIdentifier, Integer>> mapping;
    ...
    public Map<UniProtIdentifier, Map<AuthLeafIdentifier, Integer>> getMapping() {
        return mapping;
    }
                        ...
                        if (dbSource.equals("PDB")) {
                            ...
                            if (dbResNum.equals("null")) {
                                ...
                                if (matcher.matches()) {
                                    ...
                                    currentInsertionCode = matcher.group(2).isEmpty() ? AuthLeafIdentifier.DEFAULT_INSERTION_CODE : matcher.group(2).charAt(0);
                                }
                            }
        ...
        switch (qName) {
            case "residue": {
                ...
                if (skip) {
                    ...
                    AuthLeafIdentifier leafIdentifier = new AuthLeafIdentifier(currentPdbid, currentModel, currentChain, currentResidue, currentInsertionCode);
