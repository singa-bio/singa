 ...
 */
public class ModuleCell extends ListCell<AvailableModule> {
    ...
    @Override
    public void updateItem(AvailableModule module, boolean empty) {
    ...
    private void addContent(AvailableModule module) {
        setText(null);
