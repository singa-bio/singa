...
public enum MooreRectangularDirection implements DiscreteDirection {
    ...
    public static RectangularCoordinate getNeighborOf(RectangularCoordinate coordinate, MooreRectangularDirection coordianteDirection, MooreRectangularDirection relativeDirection) {
        int addX = 0;
        if (coordianteDirection.directionX != relativeDirection.directionX) {
            addX = relativeDirection.directionX;
        }
        int addY = 0;
        if (coordianteDirection.directionY != relativeDirection.directionY) {
