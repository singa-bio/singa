...
public class CellSubsections {
    ...
    public static final CellSubsection CELL_OUTER_MEMBRANE = new CellSubsection("cell outer membrane", new GoTerm("GO:0009279","cell outer membrane", GOA_DATABASE), true);
    ...
    public static final CellSubsection NUCLEAR_MEMBRANE = new CellSubsection("nuclear membrane", new GoTerm("GO:0031965", "nuclear membrane", GOA_DATABASE), true);
    ...
    public static final CellSubsection EARLY_ENDOSOME_MEMBRANE = new CellSubsection("early endosome membrane", new GoTerm("GO:0031901","early endosome membrane", GOA_DATABASE), true);
