...
public class DefaultFeatureSources {
    ...
    public static final Evidence LANG2000 = new FeatureOrigin(FeatureOrigin.OriginType.LITERATURE, "Lang 2000", "Lang, Thorsten, et al. \"Role of actin cortex in the subplasmalemmal transport of secretory granules in PC-12 cells.\" Biophysical journal 78.6 (2000): 2863-2877.");
