 ...
 * @author cl
 */
public class BuddingFrequency extends ScalableQuantityFeature<Frequency> {

    public static final String SYMBOL = "k_bud";

    public BuddingFrequency(Quantity<Frequency> frequencyQuantity, FeatureOrigin featureOrigin) {
        super(frequencyQuantity, featureOrigin);
    }

    public BuddingFrequency(double frequency, FeatureOrigin featureOrigin) {
