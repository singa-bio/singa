...
class ReactionChainTest {
    ...
    private static ChemicalEntity pp2b;

    @BeforeAll
    static void initialize() {
        akap = SimpleEntity.create("AKAP")
                .membraneBound()
                .build();
        pkar = SimpleEntity.create("PKAR").build();
        pkac = SimpleEntity.create("PKAC").build();
        aqp = SimpleEntity.create("AQP2").build();
        pde = SimpleEntity.create("PDE").build();
        pp2b = SimpleEntity.create("PP2B").build();

        p = SimpleEntity.create("P")
                .small()
                .build();
        atp = SimpleEntity.create("ATP")
                .small()
                .build();
        camp = SimpleEntity.create("CAMP")
                .small()
                .build();
    }
