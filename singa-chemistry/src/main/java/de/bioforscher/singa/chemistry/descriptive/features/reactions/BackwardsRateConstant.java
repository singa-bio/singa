 ...
 * @author cl
 */
public class BackwardsRateConstant extends AbstractFeature<Quantity<Frequency>> implements ScalableFeature<Quantity<Frequency>> {

    public static final String SYMBOL = "k_bwd";

    private Quantity<Frequency> scaledQuantity;
    private Quantity<Frequency> halfScaledQuantity;

    public BackwardsRateConstant(Quantity<Frequency> frequencyQuantity, FeatureOrigin featureOrigin) {
        super(frequencyQuantity, featureOrigin);
    }

    public BackwardsRateConstant(double frequency, FeatureOrigin featureOrigin) {
