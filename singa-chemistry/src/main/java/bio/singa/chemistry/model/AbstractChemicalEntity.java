 ...
 * @author cl
 */
public abstract class AbstractChemicalEntity implements Featureable, Annotatable {
    ...
    public static abstract class Builder<TopLevelType extends AbstractChemicalEntity, BuilderType extends Builder> {
